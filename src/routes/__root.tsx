...
// canonical/OG URLs from `Astro.url` per-page; here the site root is
// hardcoded since this is the shared root head (Task 13's resume route sets
// its own head with its own canonical URL).
